...
public class exercicio3 {
    public static void main(String[] args) {
        ...
        while (flag == false) {
            System.out.println("Digite um numero para ser o multiplicando:");
            multiplicando = ler.nextInt();

            System.out.println("Digite um valor de inicio de intervalo: ");
            inicio = ler.nextInt();

            System.out.println("Digite um valor de fim de intervalo:");
            fim = ler.nextInt();
